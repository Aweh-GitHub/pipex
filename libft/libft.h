...
/*   Updated: 2026/01/09 14:34:00 by thantoni         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char			tc(int con, char val_true, char val_false);
int				ti(int con, int val_true, int val_false);
long unsigned	tlu(int con, \
	long unsigned val_true, long unsigned val_false);
void			*tp(int con, void *val_true, void *val_false);
char			*ts(int con, char *val_true, char *val_false);
double			tf(int con, double val_true, double val_false);
